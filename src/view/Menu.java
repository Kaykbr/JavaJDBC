...
public class Menu extends javax.swing.JFrame {
    ...
    private void copyMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_copyMenuItemActionPerformed
        TelaRelatório tr = new TelaRelatório();
        
        Dimension desktopSize = painelDesktop.getSize();
        Dimension jInternalFrameSize = tr.getSize();
        int width = (desktopSize.width - jInternalFrameSize.width) / 2;
        int height = (desktopSize.height - jInternalFrameSize.height) / 2;
        tr.setLocation(width, height);

        painelDesktop.add(tr);
        tr.setVisible(true);
    ...
    private void cadastroLivroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastroLivroActionPerformed
           TelaCadastroLivro1 telaLivro = new TelaCadastroLivro1();
